...
CALL GO run ./scripts/ssllabs-scan.go --usecache=true --maxage=48 --ignore-mismatch=true --hostfile ./data/hosts/hosts%_SCANGROUP%.txt > ./data/ssllabsReports/ssllabsReport%_SCANGROUP%.json
